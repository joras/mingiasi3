...
// this file contains subset of zod-types created by a script
  ...
  z.object({
    ...
    related_objects: z.object({
      organization: z.object({
        ORGANIZATION_ID: z.intersection(
          z.object({
            id: z.number().int().optional(),
          }),
          z.object({
